"""Launch pick action pipeline: scan source + recognition + action server.

Usage:
  ros2 launch pick_action pick_action.launch.py                          # synthetic scan
  ros2 launch pick_action pick_action.launch.py use_synthetic:=false      # real LiDAR (needs ldlidar_stl_ros2 built)
"""
...
def generate_launch_description():
    ...
    # Real LiDAR driver — only included when package is available
    try:
        ...
        actions.append(LogInfo(
            msg='ldlidar_stl_ros2 not found; real LiDAR disabled'
        ))
    ...
    actions.append(recognition_node)
